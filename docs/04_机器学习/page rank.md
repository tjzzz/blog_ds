...
![](../../media/Pasted%20image%2020220423180726.png)
...
![](../../media/Pasted%20image%2020220423205408.png)

在该图中节点C没有，转移矩阵M此时不是一个随机矩阵，因为存在某列和不是1。如果用前面说的方式，随着时间的推移，最终计算得到的各个节点的概率变为0
![](../../media/Pasted%20image%2020220423205957.png)
...
![](../../media/Pasted%20image%2020220428100903.png)
...
回到pageRank的计算
![](../../media/Pasted%20image%2020220428103907.png)
